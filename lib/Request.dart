...
var reason,counciller,councillerId,postingUserId,type,categoryId,semesterId,departmentId,studentId;
SharedPreferences sp;
DateTime meetingDate;
List councillers,types;
ProgressDialog pr;
...
_submit() async{
   if(_formKey.currentState.validate()){
      ...
      pr.hide();
      result==true?alertSucess("Alert","Your Councill Request Submited."):alertError("Alert","Something Went Wrong");
   }
}
